...
class PasswordGeneratorUI(QMainWindow):
    ...
    def apply_stylesheet(self):
        ...
        self.setStyleSheet(f"""
            ...
            #titleLabel {{
                color: {self.PINK_VERY_DARK};
                margin-bottom: 8px;
            }}
            
            QGroupBox {{
                border: 2px solid {self.PINK_MEDIUM};
                border-radius: 8px;
                margin-top: 12px;
                font-weight: bold;
                font-size: 13px;
            ...
            QLineEdit {{
                ...
                background-color: {self.WHITE};
                color: {self.BLACK};
                selection-background-color: {self.PINK_LIGHT};
            }}
            
            QLineEdit:focus {{
                border-color: {self.PINK_DARK};
            }}
            ...
            QPushButton {{
                background-color: {self.PINK_MEDIUM};
                color: {self.BLACK};
                border: none;
                border-radius: 5px;
                padding: 7px 12px;
            ...
            QPushButton:hover {{
                background-color: {self.PINK_DARK};
                color: {self.WHITE};
            }}
            
            QPushButton:pressed {{
                background-color: {self.PINK_VERY_DARK};
            }}
            ...
            QSlider::handle:horizontal {{
                ...
                border: 1px solid {self.PINK_DARK};
                width: 16px;
                height: 16px;
                margin: -5px 0;
                border-radius: 8px;
            ...
            QSlider::handle:horizontal:hover {{
                background: {self.PINK_VERY_DARK};
            }}
            ...
            QListWidget::item:selected {{
                background-color: {self.PINK_LIGHT};
                color: {self.BLACK};
            }}
    ...
    def copy_password(self):
        ...
        if password:
            ...
            self.copy_button.setStyleSheet(f"background-color: {self.PINK_VERY_DARK}; color: {self.WHITE};")
